...
@WebServlet("/color-survey")
public class ColorSurveyServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for (String color : colorArray) {
      ...
      Query query = new Query("ColorSurvey").setFilter(colorFilter);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    Query query = new Query("ColorSurvey");
    PreparedQuery results = datastore.prepare(query);

    // captures the vote by user
    Entity newVote = new Entity("ColorSurvey");
